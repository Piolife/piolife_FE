...
import { pharmacySignupFormData } from "@/services/core/types";
...
import { validatePharmacyForm } from "@/hooks/auth";
...
const PharmSignup = () => {
  ...
  const [errors, setErrors] = useState<Partial<pharmacySignupFormData>>({});
  ...
  const handleChange = (name: any, value: any) => {
    const validationErrors = validatePharmacyForm(formData);
                ...
                {step === 1 && (
                  <View className="flex flex-col gap-[16px]">
                    ...
                    <CustomTextInput
                      ...
                      onChangeText={(value) =>
                        handleChange("pharmacyName", value)
                      }
                      placeholder="Enter facility Name"
                      placeholderTextColor={"#BABABA"}
                      keyboardType="default"
                      errorMessage={errors.pharmacyName}
                    />
                    <CustomTextInput
